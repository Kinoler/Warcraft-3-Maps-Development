...
function mh_read_memory takes nothing returns nothing
local integer array mh_readonly_array
local integer mh_index = 0
local integer mh_result
    set mh_result = mh_readonly_array[mh_index]
endfunction